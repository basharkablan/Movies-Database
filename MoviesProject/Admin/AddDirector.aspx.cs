...
public partial class Admin_AddDirector : System.Web.UI.Page
{
    ...
    protected void AddDirectorButton_Click(object sender, EventArgs e)
    {
        ...
        if (firstName != "" && lastName != "")
        {
            ...
            Director d1 = new Director(0, firstName, lastName, bYear, country, pic);

            Directors.AddDirector(d1);

            int DirectorID = Directors.GetLastDirectorID();
