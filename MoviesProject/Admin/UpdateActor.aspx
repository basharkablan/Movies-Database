<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="UpdateActor.aspx.cs" Inherits="Admin_UpdateActor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:Image ID="ActorPhoto" runat="server" Height="70" />
            </td>
        </tr>
    </table>
    <br />
    <asp:Button ID="UpdateActorButton" runat="server" Text="Update Actor" 
        onclick="UpdateActorButton_Click" />
